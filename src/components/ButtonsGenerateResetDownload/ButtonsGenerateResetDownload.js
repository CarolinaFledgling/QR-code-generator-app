...
function ButtonsGenerateResetDownload({ handleGenerateCode, handleResetBtn, handleDownloadFile, isDisableBtn }) {
  return <>
    ...
    <Button disabled={isDisableBtn} onClick={handleDownloadFile} sx={{ mt: "10px", width: "100%" }} color="info" variant="contained">Download File</Button>
  </>;
}
